...
function previous_output_image_button_Callback(hObject, eventdata, handles)
    try
        if(handles.output_image_cursor==1)
            handles.output_image_cursor = size(handles.FileName,2);
        else
